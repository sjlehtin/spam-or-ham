...
\title{T-61.3050 Preliminary report: Decision trees in mail classification}
...
XXX stuff about decision trees

XXX why numpy (tree structure representation, ease of use)?



Correctness: 0.920

We did some manual classification checks.  Basically, looks into the
test data with R and checking the set flags visually with command
