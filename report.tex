...
that a single tree hits a maximum accuracy, and further improvements
...
This was enough to cut down the size of the resulting trees and speed up
the training process, but left significant emphasis to the postpruning
step described in section \ref{sect:postpruning}.
